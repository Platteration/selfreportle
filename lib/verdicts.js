...
(function (root, factory) {
  ...
  const IMAGE = {
    'ai-generated': { label: 'AI-generated', short: 'AI', color: COLORS.red, rank: 6, icon: '◆' },
    'ai-edited': { label: 'AI-edited / composite', short: 'AI edit', color: COLORS.orange, rank: 5, icon: '◆' },
    'ai-disclosed': { label: 'Disclosed as AI-made', short: 'AI · disclosed', color: COLORS.amber, rank: 4, icon: '◆' },
    'suspected': { label: 'Possible AI (weak signals)', short: 'AI?', color: COLORS.yellow, rank: 3, icon: '?' },
    ...
    'no-signal': { label: 'No provenance signals found', short: '–', color: COLORS.grey, rank: 2, icon: '○' },
    'unavailable': { label: 'Could not inspect', short: 'n/a', color: COLORS.lightgrey, rank: 2, icon: '○' },
  };

  const TEXT = {
    'ai': { label: 'Strong AI indicators', short: 'AI', color: COLORS.red, rank: 6, icon: '◆' },
    'ai-disclosed': { label: 'Disclosed as AI-generated', short: 'AI · disclosed', color: COLORS.amber, rank: 4, icon: '◆' },
    'ai-assisted-disclosed': { label: 'Disclosed as AI-assisted', short: 'AI-assisted · disclosed', color: COLORS.amber, rank: 4, icon: '◆' },
    'likely-ai': { label: 'Likely AI-written (heuristic)', short: 'AI likely', color: COLORS.orange, rank: 5, icon: '◆' },
    'possible-ai': { label: 'Possibly AI-written (weak heuristic)', short: 'AI?', color: COLORS.yellow, rank: 3, icon: '?' },
    'human-disclosed': { label: 'Declared human-written (self-reported)', short: 'Human · declared', color: COLORS.green, rank: 0, icon: '●' },
    'no-signal': { label: 'No AI signals found', short: '–', color: COLORS.grey, rank: 2, icon: '○' },
  };

  const SITE = {
    'ai-built': { label: 'Built with an AI site/app generator', short: 'AI-built', color: COLORS.red, rank: 6, icon: '◆' },
    'ai-disclosed': { label: 'Site declares AI involvement', short: 'AI · disclosed', color: COLORS.amber, rank: 4, icon: '◆' },
    'ai-assisted': { label: 'AI-assisted code (indicators)', short: 'AI-assisted', color: COLORS.orange, rank: 5, icon: '◆' },
    'builder': { label: 'Conventional site builder (AI optional)', short: 'Builder', color: COLORS.blue, rank: 1, icon: '▦' },
    'no-signal': { label: 'No AI-generation signals in code', short: '–', color: COLORS.grey, rank: 2, icon: '○' },
  };

  const OVERALL = {
    'undisclosed-ai': { label: 'AI signals without disclosure', color: COLORS.red },
    'disclosed-ai': { label: 'AI use is disclosed', color: COLORS.amber },
    'weak-ai': { label: 'Weak AI signals only', color: COLORS.yellow },
    'provenance': { label: 'Provenance credentials present, no AI signals', color: COLORS.green },
    'none': { label: 'No AI signals found (not proof of human origin)', color: COLORS.grey },
  };
  ...
  return { COLORS, IMAGE, TEXT, SITE, OVERALL, info, combineImageSignals, worst, overall, AI_IMAGE_VERDICTS, AI_TEXT_VERDICTS, AI_SITE_VERDICTS };
});
