...
(function (root, factory) {
  ...
  const STREET_RE = /(?:stra(?:ss|ß)e|str\.|\b[a-zäöüß]{3,30}(?:weg|platz|allee|gasse|ring|gracht|kade|dijk|singel|gatan|gata|vagen|vägen))\b|\b(?:street|st\.|road|rd\.?|avenue|ave\.?|lane|drive|boulevard|blvd\.?|rue|voie|calle|avenida|via|viale|piazza|straat|laan|plein|gata|gatan|vej|ulica|utca|ulice)\b/i;
