...
(function (root, factory) {
  ...
  /* UTCTime is two-digit years: 50 and above mean the twentieth century. */
  function timeOf(b, tlv) {
    ...
    return new Date(Date.UTC(year, parseInt(m[2], 10) - 1, parseInt(m[3], 10), parseInt(m[4], 10), parseInt(m[5], 10), parseInt(m[6] || '0', 10)));
  }
